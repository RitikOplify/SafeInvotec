...
//       <div
//         ref={sliderRef}
//         className={`slider-container w-full h-full flex ${
//           isTransitioning
...
//           <div
//             key={index}
//             className="slide h-full w-full flex-shrink-0 flex justify-start items-center relative"
//           >
//             <img
//               src={slide.images}
//               alt={slide.title}
...
//             />
//             <div className="relative w-[45%] z-10 bg-opacity-50 p-5 rounded-lg ml-10 typewriter">
//               <h1
//                 key={activeSlide}
//                 className="text-[#AA1F2E] w-fit font-bold text-4xl overflow-hidden whitespace-nowrap animate-typing"
//               >
//                 {slide.title}
//               </h1>
...
//                 {slide.subtitle}
//               </h2>
//               <p className="text-xl mt-3">{slide.description}</p>
